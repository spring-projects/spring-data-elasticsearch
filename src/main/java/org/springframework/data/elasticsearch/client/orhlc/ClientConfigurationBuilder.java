...
import org.springframework.data.elasticsearch.client.orhlc.ClientConfiguration.ClientConfigurationBuilderWithRequiredEndpoint;
import org.springframework.data.elasticsearch.client.orhlc.ClientConfiguration.MaybeSecureClientConfigurationBuilder;
import org.springframework.data.elasticsearch.client.orhlc.ClientConfiguration.TerminalClientConfigurationBuilder;
...
class ClientConfigurationBuilder
	...
	public ClientConfiguration build() {
		...
		return new DefaultClientConfiguration(hosts, headers, useSsl, sslContext, soTimeout, connectTimeout, pathPrefix,
				hostnameVerifier, proxy, clientConfigurers, headersSupplier);
	}
