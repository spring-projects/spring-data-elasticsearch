...
public class ElasticsearchQueryMethod extends QueryMethod {
	...
	// the following 2 variables exists in the base class, but are private. We need them for
	// correct handling of return types (SearchHits), so we have our own values here.
	// Also, this means that we have to copy code that initializes these variables and in the
