 ...
 */
public class DocumentIDElasticsearchRepository<T> extends AbstractElasticsearchRepository<T, DocumentID> {

	public DocumentIDElasticsearchRepository() {
		super();
	}
	...
	public DocumentIDElasticsearchRepository(ElasticsearchOperations elasticsearchOperations) {
		super(elasticsearchOperations);
	}

	@Override
	protected String stringIdRepresentation(DocumentID id) {
