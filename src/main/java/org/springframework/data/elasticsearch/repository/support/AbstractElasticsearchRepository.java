...
public abstract class AbstractElasticsearchRepository<T, ID> implements ElasticsearchRepository<T, ID> {
	...
	private void createIndex() {
		entityClassIndexOperations.createIndex(getEntityClass());
	}

	private void putMapping() {
		entityClassIndexOperations.putMapping(getEntityClass());
	}
	...
	public Optional<T> findById(ID id) {
		return operations.get(stringIdRepresentation(id), getEntityClass(), getIndexCoordinates());
	}
