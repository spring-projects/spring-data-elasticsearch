...
The following code shows how to search for persons with a given `firstname` and for the found documents have a terms aggregation that counts the number of occurrences of the `lastnames` for these persons:
