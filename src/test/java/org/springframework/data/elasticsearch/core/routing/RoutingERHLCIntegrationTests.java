...
@ContextConfiguration(classes = { RoutingERHLCIntegrationTests.Config.class })
public class RoutingERHLCIntegrationTests extends RoutingIntegrationTests {
	...
	static class Config {
		...
		IndexNameProvider indexNameProvider() {
			return new IndexNameProvider("routing-es7");
		}
	}
