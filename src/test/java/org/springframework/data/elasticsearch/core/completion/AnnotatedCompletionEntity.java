 ...
 */
@Document(indexName = "test-completion-index", type = "annotated-completion-type", serverConfig = false, indexStoreType = "memory", shards = 1, replicas = 0, refreshInterval = "-1")
