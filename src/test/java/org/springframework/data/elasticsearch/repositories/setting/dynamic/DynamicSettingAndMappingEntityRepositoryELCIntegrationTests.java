 ...
 * @since 4.4
 */
@ContextConfiguration(classes = { DynamicSettingAndMappingEntityRepositoryELCIntegrationTests.Config.class })
public class DynamicSettingAndMappingEntityRepositoryELCIntegrationTests
